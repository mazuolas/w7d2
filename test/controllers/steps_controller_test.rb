...
class StepsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create step" do
    assert_difference('Step.count') do
      post steps_url, params: { step: { body: @step.body, done: @step.done, title: @step.title } }
    end
  ...
  test "should update step" do
    patch step_url(@step), params: { step: { body: @step.body, done: @step.done, title: @step.title } }
